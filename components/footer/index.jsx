      ...
      <div className="w-full bg-[#ebeee4] text-black mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-6 sm:gap-8">
          ...
          <div className="sm:col-span-1 lg:col-span-1 xl:col-span-1">
            <h2 className="text-[#FFCB05] font-[500] text-[18px] sm:text-lg mb-3 sm:mb-4">Service</h2>
          ...
          {/* Company */}
          <div className="sm:col-span-1 lg:col-span-1 xl:col-span-1">
            <h2 className="text-[#FFCB05] font-[500] text-[18px] sm:text-lg mb-3 sm:mb-4">Tab-Deel</h2>
            <nav className="space-y-2 text-sm">
        ...
        {/* Our Social Media */}
<div className="sm:col-span-2 lg:col-span-1 xl:col-span-1">
  <h2 className="text-[#FFCB05] font-[500] text-[18px] sm:text-lg mb-3 sm:mb-4">Our Social Media</h2>
  <nav className="space-y-2 text-sm">
    {/* Instagram */}
    ...
    {/* WhatsApp */}
    <a href="https://wa.me/97142501665" target="_blank" rel="noopener noreferrer" className="flex items-center hover:text-green-500 transition-colors duration-300 group py-1">
      <svg className="w-4 h-4 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
      ...
      WhatsApp
          ...
          {/* Join a Newsletter */}
          <div className="sm:col-span-2 lg:col-span-1 xl:col-span-1">
            <h1 className="text-[#FFCB05] font-[500] text-[18px] sm:text-lg mb-3 sm:mb-4">Join a Newsletter</h1>
                ...
                {isSubmitting ? (
                  <>
                    <svg className="animate-spin -ml-1 mr-2 h-4 w-4 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                      ...
                      <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0..."></path>
                    </svg>
                    Subscribing...
                  </>
                ) : (
